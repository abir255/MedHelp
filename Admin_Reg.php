...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($check == 0) {
        if ($pass1 == $pass2) {
            ...
            $sql2 = "SELECT * FROM `admin_account` WHERE admin_email = '$email'";
            $result1 = mysqli_query($con, $sql2);
            $num1 = mysqli_num_rows($result1);

            if ($num1 == 0) {
                $sql = "INSERT INTO `admin_account` (`admin_name`, `admin_email`, `admin_pass`, `admin_address`, `admin_phone`, `admin_dob`)
...
<body>
    ...
    <div class="form">
        ...
        <form action="/MedHelp/Admin_Reg.php" method="POST">
            ...
            <p>Have an Account?
            <ul>
                <li><a href="Admin_login.php">Login here</a></li>
            </ul>
            </p>
        </form>
    </div>
